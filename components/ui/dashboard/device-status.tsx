  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {sensors.map((sensor) => (
          <Card key={sensor.id} className="border-border bg-white">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span
                    className={`font-medium ${getBatteryColor(sensor.batteryLevel)}`}
                  >
                    {sensor.batteryLevel}%
                  </span>
                </div>
      ...
      <Card className="border-border">
        <CardHeader>
          ...
          <CardDescription>
            Detailed status and configuration of all monitoring devices
          </CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <TableRow key={sensor.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-2">
                        <Battery
                          className={`h-4 w-4 ${getBatteryColor(sensor.batteryLevel)}`}
                        />
                        <span
                          className={`text-sm font-medium ${getBatteryColor(sensor.batteryLevel)}`}
                        >
                          {sensor.batteryLevel}%
                        </span>
                      </div>
