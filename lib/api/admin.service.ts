...
export const adminService = {
  ...
  async bulkCreateDistricts(
    data: BulkCreateDistrictRequest,
  ): Promise<District[]> {
    const response = await api.post<District[]>(
      endpoints.admin.bulk.districts,
      data,
    );
    return response.data;
  },
  ...
  async bulkCreateVillages(data: BulkCreateVillageRequest): Promise<Village[]> {
    const response = await api.post<Village[]>(
      endpoints.admin.bulk.villages,
      data,
    );
    return response.data;
  },
  ...
  ): Promise<{ message: string; seeded: any }> {
